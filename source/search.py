...
def search_in_google_scholar(search_keyword):
    main_years, main_citations, main_titles, main_summaries, main_authors = [], [], [], [], []
    ...
    driver.close()
    return main_titles, main_authors, main_years, main_citations, main_summaries, articles_len
